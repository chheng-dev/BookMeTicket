...
function Register() {
    ...
    const handleSubmit = async ({ phoneNumber, password, confirm_pwd }) => {
        try {
            setLoading(true)
            const respone = axios.post(`https://63b559c858084a7af39162c7.mockapi.io/register`, {
                login: phoneNumber,
                password: password,
            ...
            <>
                ...
                >
                    <Form.Item
                        ...
                        <Input type="email" bordered addonBefore={<FiMail />} placeholder="example@gmail.com" size="large" className="rounded-lg" />
                    </Form.Item>
                    <Form.Item
                        label="Password"
                        name="password"
