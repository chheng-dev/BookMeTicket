                                ...
                                <div className="flex w-full justify-start">
                                    <div>
                                        <div className="flex gap-4">
                                            <div className="flex w-1/3 items-center justify-center mt-5">
                                                <div className="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://s1.ticketm.net/dam/a/087/d26e3794-731e-478c-b0ba-4b4648bd0087_1772721_RETINA_PORTRAIT_16_9.jpg" alt="plant" className="card-image-event" />
                                                    <div className="p-4">
                                                        <div>
                                            ...
                                            <div class="flex w-1/3 items-center justify-center mt-5">
                                                <div class="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://s1.ticketm.net/dam/a/729/c886aac1-6740-4f40-a8fa-86f70d168729_1596801_TABLET_LANDSCAPE_LARGE_16_9.jpg" alt="plant" className="card-image-event" />
                                                    <div class="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
                                        ...
                                        <span>$ 300.44</span>
                                            ...
                                            <div class="flex w-1/3 items-center justify-center mt-5">
                                                <div class="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://www.thelist.com/img/gallery/2021-music-festivals-you-need-to-have-on-your-radar/l-intro-1628720166.jpg" alt="plant" className="card-image-event" />
                                                    <div class="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
                                        ...
                                        <div className="flex gap-4">
                                            <div className="flex w-1/3 items-center justify-center mt-5">
                                                <div className="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://digitalhub.fifa.com/transform/4377dffe-e4e5-4af4-9b1b-f5da1eef9b4b/Captains-The-Chosen-Few" alt="plant" className="card-image-event" />
                                                    <div className="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
                                        ...
                                        <span>$ 300.44</span>
                                            ...
                                            <div className="flex w-1/3 items-center justify-center mt-5">
                                                <div className="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://www.withinnigeria.com/news/wp-content/uploads/sites/5/2021/11/ify_davies/2021/11/17/skysports-world-cup-raheem-sterling_5316432.jpg" alt="plant" className="card-image-event" />
                                                    <div className="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
                                        ...
                                        <span>$ 300.44</span>
                                            ...
                                            <div className="flex w-1/3 items-center justify-center mt-5">
                                                <div className="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIpLaVAEMyYoMnSxkgfLhXZSs1rt5SkWjAFD6Ir6ii7R1Sql3iJJIKrgtcTN6rZjL_VMA&usqp=CAU" alt="plant" className="card-image-event" />
                                                    <div className="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
                                        ...
                                        <div className="flex gap-4">
                                            <div className="flex w-1/3 items-center justify-center mt-5">
                                                <div className="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://thumbs.dreamstime.com/b/business-speaker-giving-talk-conference-hall-event-audience-entrepreneurship-concept-76866426.jpg" alt="plant" className="card-image-event" />
                                                    <div className="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
                                        ...
                                        <span>$ 300.44</span>
                                            ...
                                            <div class="flex w-1/3 items-center justify-center mt-5">
                                                <div className="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://media.slidesgo.com/storage/8857150/leadership-training-event-for-business1626957387.jpg" alt="plant" className="card-image-event" />
                                                    <div className="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
                                            ...
                                            <div class="flex w-1/3 items-center justify-center mt-5">
                                                <div className="max-w-sm overflow-hidden rounded-xl bg-white shadow-xl duration-200">
                                                    <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/leadership-training-workshop-seminar-network-design-template-d51f2c88e56e880dbfd6f30d5afc50b2_screen.jpg?ts=1574267040" alt="plant" className="card-image-event" />
                                                    <div className="p-4">
                                                        <div>
                                                            <span className="text-xs text-gray-400">11-Mar - 12-Mar</span>
                                                        </div>
