...
function Ticket() {
    ...
    return (
        <div>
            ...
            <div className="w-full text-black p-4 pt-16 md:pt-0 md:p-0 dark:text-white">
                ...
                <div className="max-w-sm bg-white dark:bg-gray-900 mx-auto">
                    <div className="box-shadow">
                        ...
                        <div className="p-6 text-sm">
                            ...
                            <p className="text-gray-400 my-1">Ticket No: <span className="text-black font-semibold dark:text-white">{product.trackingId}</span></p>
                    ...
                    <div className="mt-4 ">
                        <Button type="primary" block className="hover:bg-primary-400 text-white py-2 px-4 rounded-md">
