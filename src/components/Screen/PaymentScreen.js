            ...
            <div className="w-full text-black mt-8 pb-8">
                <div className="container m-auto">
                    <div className="flex gap-12">
                                ...
                                <div>
                                    <div class="flex bg-white border border-gray-400 rounded">
                                        <div className="w-full h-full">
                                            <div class="flex items-start px-8 py-3 gap-2">
                                                <div className="flex">
                                                    <img class="w-14 h-10  mr-4 shadow" src={abaLogo} alt="avatar" />
                                                </div>
                                                <div class="flex-block w-3/6">
                                                    <div class="flex items-center justify-between">
                                                        <h2 class="text-sm font-semibold text-gray-900 -mt-1">ABA PAY</h2>
                                    ...
                                    <div class="flex bg-white border my-3 border-gray-400 rounded">
                                        <div className="w-full h-full">
                                            <div class="flex items-start px-8 py-3 gap-2">
                                                <div className="flex">
                                                    <img class="w-14 h-10  mr-4 shadow" src={creditLogo} alt="avatar" />
                                                </div>
                                                <div class="flex-block w-3/6">
                                                    <div class="flex items-center justify-between">
                                                        <h2 class="text-sm font-semibold text-gray-900 -mt-1">ABA PAY</h2>
                                                ...
                                                <div className="flex w-2/6 justify-end">
                                                    <svg t="1669179384368" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5892" width="22" height="22"><path d="M512 213.333333a298.666667 298.666667 0 1 1-298.666667 298.666667 298.666667 298.666667 0 0 1 298.666667-298.666667m0-85.333333a384 384 0 1 0 384 384A384 384 0 0 0 512 128z" p-id="5893" fill="#2EBAE2"></path></svg>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="flex w-2/5 h-full rounded max-w-sm">
