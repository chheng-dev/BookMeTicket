            ...
            <div className="container m-auto">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        <div class="flex items-start  bg-white hover:-mt-0.5 hover:bg-gray-100 p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-150 ease-out hover:ease-in">
                            ...
                            <div class="ml-4 pt-3 justify-center">
                                <h2 class="font-semibold">Sport</h2>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start  bg-white hover:-mt-0.5 hover:bg-gray-100 p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-150 ease-out hover:ease-in">
                            ...
                            <div class="ml-4 pt-3 justify-center">
                                <h2 class="font-semibold inline-block align-middle">Concert</h2>
                        ...
                        <div class="flex items-start  bg-white hover:-mt-0.5 hover:bg-gray-100 p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-150 ease-out hover:ease-in">
                            ...
                            <div class="ml-4 pt-3 justify-center">
                                <h2 class="font-semibold">Community Meetups</h2>
                        ...
                        <div class="flex items-start  bg-white hover:-mt-0.5 hover:bg-gray-100 p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-150 ease-out hover:ease-in">
                            ...
                            <div class="ml-4 pt-3 justify-center">
                                <h2 class="font-semibold">Skill Training</h2>
